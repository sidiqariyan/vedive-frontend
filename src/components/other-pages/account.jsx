...
const Account = () => {
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        const userData = await fetchData("://ec2-51-21-1-175.eu-north-1.compute.amazonaws.com:3000/api/dashboard", {
          method: "GET",
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.newPassword) {
      try {
        const response = await fetch("https://vedive.com:3000/api/auth/update-password", {
          method: "PUT",
          headers: {
